...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="<?php echo base_url(); ?><?php echo base_url(); ?>assets/img/favicon.ico"/>
    <!-- BEGIN GLOBAL MANDATORY STYLES -->
    <link href="https://fonts.googleapis.com/css?family=Nunito:400,600,700" rel="stylesheet">
    <link href="<?php echo base_url().'/recursos/'?>bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url().'/recursos/'?>assets/css/plugins.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo base_url().'/recursos/' ?>assets/css/authentication/form-2.css" rel="stylesheet" type="text/css" />
...
<body class="form">
    ...
    <script src="<?php echo base_url().'/recursos/' ?>assets/js/libs/jquery-3.1.1.min.js"></script>
    <script src="<?php echo base_url().'/recursos/' ?>bootstrap/js/popper.min.js"></script>
    <script src="<?php echo base_url().'/recursos/' ?>bootstrap/js/bootstrap.min.js"></script>

    <!-- END GLOBAL MANDATORY SCRIPTS -->
    <script src="<?php echo base_url().'/recursos/' ?>assets/js/authentication/form-2.js"></script>
